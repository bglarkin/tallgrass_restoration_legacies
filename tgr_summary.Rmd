...
```{r its_rarefaction_pre,out.width="100%",fig.cap="\\label{fig:its_rarefaction_pre}Pre"}
include_graphics("microbial_diagnostics_pre_files/figure-gfm/its_rarefaction_curve_fig-1.png")
```

```{r its_rarefaction_post,out.width="100%",fig.cap="\\label{fig:its_rarefaction_post}Post"}
