...
With guilds, trends across field types vary among regions. 
...
```{r guilds-regions,out.width="80%",fig.cap="Abundant or dynamic guilds across field types in regions, ITS dataset."}
