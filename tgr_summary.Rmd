...
author: "Beau Larkin, coauthors L Bullington, Y Lekberg, and P Ramsey"
...
kable(caption = "Average sequence abundances per field in each field type are shown for the top six guilds.", format = "pandoc")
```
