...
```{r gigatime,out.width="100%",fig.cap="Icons show sums of 18S sequences in each restored field from the Blue Mounds region. The abundance of taxa in the *Gigasporaceae* increase with years since restoration ($R^2_{Adj}=0.61,~p=0.023$)."}
