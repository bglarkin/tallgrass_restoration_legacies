...
```{r fgrp-gld,out.width="80%",fig.cap="Points show summed sequence abundance in pathogen and saprotroph guilds as they respond to C4 grass and forb cover in restored fields from the Blue Mounds region. Shading indicates years since restoration, a clear confounding element. Solid lines, when present, show significnt correlations. See text for statistics."}
