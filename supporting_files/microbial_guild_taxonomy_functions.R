#' ---
#' title: "Functions for microbial_guild_taxonomy"
#' author: "Beau Larkin\n"
...
#'
#' # Description
#' The functions used in the guild/taxonomy [report](tallgrass_restoration_legacies/microbial_guild_taxonomy.md) are written out here
